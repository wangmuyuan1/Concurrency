...
public class Nio2AsynchronousClient {

	public static void main(String[] args) throws UnknownHostException {
        final int DEFAULT_PORT = 6000;
        final String localhostname = "127.0.0.1"; 
        ...
        try (AsynchronousSocketChannel asynchronousSocketChannel = AsynchronousSocketChannel.open()) {
            ...
            if (asynchronousSocketChannel.isOpen()) {
                ...
                Void connect = asynchronousSocketChannel.connect(new InetSocketAddress(localhostname, DEFAULT_PORT)).get();
